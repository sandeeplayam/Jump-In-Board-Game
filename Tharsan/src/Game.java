...
public class Game {
	...
	private PieceEnums rabbitWhite, rabbitOrange, rabbitGrey;
	private PieceEnums foxRed, foxOrange;
	private PieceEnums mushroom1, mushroom2, mushroom3;
	private Hole hole1, hole2, hole3, hole4, hole5;
	private HashMap<String, PiecesInterface> gamePieces;
	...
	public void createBoard(int challengeNum) {
		...
		switch (challengeNum) {
		case 1:
			this.rabbitWhite = PieceEnums.RABBIT;
			this.rabbitWhite.setPos(0, 1);
			this.rabbitWhite.setColor(Color.white);
			this.gamePieces.put("rabbit white", this.rabbitWhite);
			this.rabbitOrange = PieceEnums.RABBIT;
			this.rabbitOrange.setPos(4, 2);
			this.rabbitOrange.setColor(Color.orange);
			this.gamePieces.put("rabbit white", this.rabbitOrange);
			this.hole1 = new Hole(0, 0);
			this.hole2 = new Hole(0, 4);
			this.hole3 = new Hole(2, 2);
			this.hole4 = new Hole(4, 0);
			this.hole5 = new Hole(4, 4);
			this.mushroom1 = PieceEnums.MUSHROOM;
			this.mushroom1.setPos(0, 3);
			this.mushroom2 = PieceEnums.MUSHROOM;
			this.mushroom2.setPos(1, 2);
			this.mushroom3 = PieceEnums.MUSHROOM;
			this.mushroom3.setPos(3, 2);
