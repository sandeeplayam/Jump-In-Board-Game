...
/**
 * The ActionStorage class stores the x, y coordinates of game pieces and keeps
 * track of them through the use of multiple stacks.
 * 
...
public class ActionStorage {
	...
	/**
	 * Constructor of the ActionStorage class which initializes all the stacks being
	 * used in the class and initializes currentMove to -1 to indicate no moves have
	 * been made yet.
	 */
	...
	/**
	 * addMove method records the current location and new location of a game piece
	 ...
	 * @param normalMove normalMove indicates what type of move it is, 0 for undo, 1
	 *                   for a regular move, and 2 for a redo
	 */
	...
	/**
	 * addUndoMove method stores the current location and previous location of a
	 * game piece into the redo stacks
	 */
	...
	/**
	 * getX method returns an element from the movex stack, that element being a x
	 * coordinate for a game piece
	 * 
	...
	/**
	 * getY method returns an element from the movey stack, that element being a y
	 * coordinate for a game piece
	 * 
	 * @param i index of the stack that one would like to retrieve from
	...
	/**
	 * getundoX method returns an element from the redox stack, that element being a
	 * x coordinate for a game piece
	 * 
	 * @param i index of the stack that one would like to retrieve from
	...
	/**
	 * getundoY method returns an element from the redoy stack, that element being a
	 * y coordinate for a game piece
	 * 
	 * @param i index of the stack that one would like to retrieve from
