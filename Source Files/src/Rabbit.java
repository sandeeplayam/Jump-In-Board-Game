...
public class Rabbit extends Slot {
	...
	private int canHop(Slot[][] board, int row, int col, int direction, int spaces) {
		...
		if (board[row][col].getClass() == Mushroom.class || board[row][col].getClass() == Rabbit.class 
				|| board[row][col].getClass() == Fox.class|| (board[row][col].getClass() ==  Hole.class
				&& ((Hole) board[row][col]).hasGamePiece())) {
		...
		} else if (board[row][col].getClass() ==  Slot.class || (board[row][col].getClass() == Hole.class && !((Hole) board[row][col]).hasGamePiece())) {
			return spaces;
		}
	...
	public boolean move(Slot[][] board, int xPos, int yPos) {
		...
		if (board[xPos][yPos].getClass() == Hole.class) {
		...
		if (board[this.getX()][this.getY()].getClass() == Hole.class) {
